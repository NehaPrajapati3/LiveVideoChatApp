...
//           users.forEach(({ socketId, userId: remoteUserId }) => {
//             if (peersRef.current.find((p) => p.userId === remoteUserId)) return;
...
//               peer,
//             });
//             peerList.push({ userId: remoteUserId, peerID: socketId, peer });
//           });
...
//           if (existing) {
//             return prev.map((r) =>
//               r.peerID === peerID ? { peerID, stream } : r
//             );
//           }
